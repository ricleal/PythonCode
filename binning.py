...
class TestBinning(unittest.TestCase):
    ...
    def test_log_10(self):
        logarithim = Binning(0.1, 1, 10, base=10)
        self.assertTrue(
            np.allclose(
                logarithim.bins,
                np.array(
        ...
        self.assertEqual(logarithim.get_bin_index(0.2), 3)
        self.assertEqual(logarithim.get_bin_index(0.22), 4)

        self.assertEqual(logarithim.get_bin_index_log_manual(0.00001), -41)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.1), 0)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.2), 3)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.22), 3)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.27), 4)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.5), 6)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.7), 8)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.8), 9)
        self.assertEqual(logarithim.get_bin_index_log_manual(0.9), 9)
        self.assertEqual(logarithim.get_bin_index_log_manual(1.0), 10)
