...
class Dispersion(object):
    ...
    def __init__(self, npts=None, width=None, nsigmas=None):
        ...
        print "Dispersion initialised with: npts=", self.npts,"; width=", self.width, "; self.nsigmas=", self.nsigmas 
...
def test():
    ...
    for k,_ in models.items():
        ...
        kwargs = dict(disperser = k, n=100, width=0.1, nsigmas=3, value=70, limits=[0,1000], relative=True)
        v,w = get_weights(**kwargs)
        plot(v,w,**kwargs)
