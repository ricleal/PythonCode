...
"""
Basic thread locking with acquire() / release().

Launches multiple threads that share a lock to serialize access to
a critical section. Demonstrates the fundamental pattern of manually
acquiring and releasing a threading.Lock.
"""
