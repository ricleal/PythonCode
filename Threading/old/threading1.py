...
"""
Thread synchronization with Locks — two styles (archived copy).

See Threading/threading1.py for the current version.

Demonstrates thread safety using threading.Lock via acquire/release
and the 'with lock' context manager.
"""
